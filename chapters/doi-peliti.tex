...
Finally, for $\rho = 1$\todo{why?}, the chance that we complete the coupons at time $t$ is
%
\begin{align}
...
\end{align}
%$
\todo[inline]{Its a it unclear here why you chose $\tilde\phi$ or $\phi^\dagger$...}
